...
async function getFacilities(params: { hsa?: string; q?: string; hospital_type?: string }) {
...
export default async function FacilitiesPage({ searchParams }: { searchParams: { hsa?: string; q?: string; hospital_type?: string } }) {
