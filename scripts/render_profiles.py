...
def head_html(title: str) -> str:
    return (
        ...
        f"{inline_css()}"
        "<style>.mode-minimal .header{display:none!important}.mode-minimal #pf-controls{display:none!important} .mode-minimal body{background:#fff}</style>"
